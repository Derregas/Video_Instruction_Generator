...
class LLMSettings:
    ...
    SYSTEM_PROMPT: str = (
        ...
        3. Следуй строго по порядку транскрипции видео. В первых шагах не должно быть информации из середины или конца транскрипции.
        4. Не упоминай видео. Инструкцию должен понять человек, у которого нет к нему доступа. Он видит только текст и картинки.
        5. Для каждого шага укажи:
        - 'title': краткое название действия.
        - 'description': подробная и четкая инструкция в повелительном наклонении. Не приводи в ней тайм-коды<div class=""></div>
